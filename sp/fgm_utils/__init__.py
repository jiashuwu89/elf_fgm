...
#    print(f"pos_data:{df['pos_gei']}")
    ...
    [
        fgs_fsp_igrf_dmxl_x, fgs_fsp_igrf_dmxl_y, fgs_fsp_igrf_dmxl_z] = parameter.fsp_func(
            ctime, cross_times_calib, T_spins_d_calib, fgs_igrf_dmxl_x, fgs_igrf_dmxl_y, fgs_igrf_dmxl_z
    )
    [
        fgs_fsp_ful_dmxl_x, fgs_fsp_ful_dmxl_y, fgs_fsp_ful_dmxl_z] = parameter.fsp_func(
    ...
    # get igrf gei
    [
        fgs_fsp_igrf_gei_x, fgs_fsp_igrf_gei_y, fgs_fsp_igrf_gei_z] = parameter.fsp_func(
    ...
    if parameter.gei2obw == True:
        [pos_fsp_gei_x, pos_fsp_gei_y, pos_fsp_gei_z] = parameter.fsp_func(ctime, cross_times_calib, T_spins_d_calib, pos_gei_x, pos_gei_y, pos_gei_z)
