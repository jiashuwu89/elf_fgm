...
def step1(
    ...
    if parameter.cali_2nd == True:
        ...
        if parameter.cali_3rd == True:
            """
                1.8 third calibration
            """
            # B ful rotate from dmxl to smxl
            [
                fgs_ful_smxl_3rd_x, fgs_ful_smxl_3rd_y, fgs_ful_smxl_3rd_z] = coordinate.dmxl2smxl(
                    fgs_ful_dmxl_3rd_x, fgs_ful_dmxl_3rd_y, fgs_ful_dmxl_3rd_z, phi_2nd
            )
            # B ful rotate from smxl to fgm
            [
                fgs_ful_fgm_3rd_x, fgs_ful_fgm_3rd_y, fgs_ful_fgm_3rd_z] = coordinate.smxl2fgm(
                    fgs_ful_smxl_3rd_x, fgs_ful_smxl_3rd_y, fgs_ful_smxl_3rd_z
            )
            # B igrf rotate from dmxl to smxl
            [
            ...
            logger.debug(f"[1.9] zero crossing calib 1-3 is done for third calibration. ")
            ...
            logger.debug(f"[1.10] phi angle calib is done for third calibration. ")
